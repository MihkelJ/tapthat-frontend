...
type PostV1IdentityConfigPositiveVariant1 = {
  ...
  data: {
    ...
    endpointType?: (('https' | 'celo' | 'staging_celo' | 'staging_https') | undefined) | undefined;
    ...
    disclosures?:
      ...
      | undefined;
    userDefinedData?: (string | undefined) | undefined;
  };
};
...
export interface EncodedResponse {
  'get /v1/health': GetV1HealthPositiveResponseVariants & GetV1HealthNegativeResponseVariants;
  'post /v1/callback': PostV1CallbackPositiveResponseVariants & PostV1CallbackNegativeResponseVariants;
  'get /v1/beer-taps': GetV1BeerTapsPositiveResponseVariants & GetV1BeerTapsNegativeResponseVariants;
  'get /v1/status/:txHash': GetV1StatusTxHashPositiveResponseVariants & GetV1StatusTxHashNegativeResponseVariants;
...
export interface Response {
  'get /v1/health': PositiveResponse['get /v1/health'] | NegativeResponse['get /v1/health'];
  'post /v1/callback': PositiveResponse['post /v1/callback'] | NegativeResponse['post /v1/callback'];
  'get /v1/beer-taps': PositiveResponse['get /v1/beer-taps'] | NegativeResponse['get /v1/beer-taps'];
  'get /v1/status/:txHash': PositiveResponse['get /v1/status/:txHash'] | NegativeResponse['get /v1/status/:txHash'];
  'post /v1/identity/verify':
...
const defaultImplementation: Implementation = async (method, path, params) => {
  ...
  const response = await fetch(new URL(`${path}${searchParams}`, 'https://yodl-store-webhook.fly.dev'), {
...
export class Client {
  ...
  public provide<K extends Request>(request: K, params: Input[K]): Promise<Response[K]> {
